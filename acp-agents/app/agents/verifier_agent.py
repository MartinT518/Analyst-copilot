        ...
        try:
            ...
            for check_data in response_data.get("verification_checks", []):
                try:
                    ...
                    for ref_id in ref_ids:
                        matching_refs = [ref for ref in input_data.knowledge_base_context + verification_knowledge 
                    ...
                    self.logger.warning("Failed to parse verification check", error=str(e), check_data=check_data)
                    continue
            ...
            for consistency_data in response_data.get("consistency_checks", []):
                try:
                    ...
                    self.logger.warning("Failed to parse consistency check", error=str(e), consistency_data=consistency_data)
                    continue
