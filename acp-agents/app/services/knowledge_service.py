...
class KnowledgeService:
    ...
    async def search(
        ...
        try:
            ...
            search_data = {
                ...
                or self.settings.kb_similarity_threshold,
            }
            ...
            response = await self.client.post(
                f"{self.settings.ingest_service_url}/api/v1/search", json=search_data
            )
    ...
    async def get_knowledge_stats(self) -> Dict[str, Any]:
        ...
        """
        try:
            response = await self.client.get(f"{self.settings.ingest_service_url}/api/v1/stats")
    ...
    async def health_check(self) -> bool:
        ...
        """
        try:
            response = await self.client.get(f"{self.settings.ingest_service_url}/health")
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        average_duration = (
            self.total_duration / self.total_searches if self.total_searches > 0 else 0.0
        )
