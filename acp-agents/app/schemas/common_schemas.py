...
class BaseAgentOutput(BaseModel):
    ...
    generated_at: datetime = Field(default_factory=datetime.utcnow, description="When this output was generated")
...
class WorkflowStep(BaseModel):
    ...
    status: WorkflowStatus = Field(default=WorkflowStatus.PENDING, description="Status of this step")
...
class WorkflowContext(BaseModel):
    ...
    knowledge_references: List[KnowledgeReference] = Field(default_factory=list, description="Relevant knowledge")
    shared_data: Dict[str, Any] = Field(default_factory=dict, description="Data shared between steps")
...
class AgentMetrics(BaseModel):
    ...
    average_duration: float = Field(default=0.0, description="Average processing duration in seconds")
...
class ErrorInfo(BaseModel):
    ...
    occurred_at: datetime = Field(default_factory=datetime.utcnow, description="When the error occurred")
