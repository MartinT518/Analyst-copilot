...
class MarkdownParser:
    ...
    def _extract_document_metadata(self, content: str, frontmatter: Dict[str, Any]) -> Dict[str, Any]:
        """
        Extract document metadata.
        ...
        metadata_fields = [
            'author', 'date', 'created', 'modified', 'tags', 'category',
            'description', 'summary', 'keywords', 'slug'
        ]
