...
class CodeParser:
    ...
    def __init__(self):
        ...
        self.supported_languages = ["java", "python", "javascript", "typescript", "csharp", "go"]
    ...
    async def _parse_codebase(self, codebase_path: str, metadata: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def _generate_code_summary(self, file_path: str, language: str, classes: List, methods: List, dependencies: List) -> str:
        ...
        if methods:
            ...
            summary_parts.append(f"Defines {len(methods)} method(s) including: {', '.join(method_names)}.")
    ...
    async def _parse_code_content(self, content: str, metadata: Dict[str, Any]) -> List[Dict[str, Any]]:
