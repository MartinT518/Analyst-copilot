...
class RBACService:
    ...
    def check_data_access(
        self, user: User, sensitivity_level: SensitivityLevel, db: Session
    ) -> bool:
        """
    ...
    def assign_role_to_user(
        self, user_id: int, role_name: str, assigned_by: int, db: Session
    ) -> bool:
        """
    ...
    def remove_role_from_user(
        self, user_id: int, role_name: str, removed_by: int, db: Session
    ) -> bool:
        """
    ...
    def can_manage_user(self, manager: User, target_user: User, db: Session) -> bool:
        """
