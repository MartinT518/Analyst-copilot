...
class SecretsManager:
    ...
    def get_llm_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "embedding_endpoint": self.get_secret(
    ...
    def validate_secrets(self) -> Dict[str, Any]:
        ...
        Returns:
            Validation results
        """
        required_secrets = ["SECRET_KEY", "DATABASE_PASSWORD", "OPENAI_API_KEY"]
...
secrets_manager = SecretsManager(encryption_key=os.getenv("SECRETS_ENCRYPTION_KEY"))
