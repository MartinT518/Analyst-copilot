...
def staging(
    ...
    dry_run: bool = typer.Option(
        False, "--dry-run", help="Show what would be deployed without actually deploying"
    ),
    force: bool = typer.Option(
        False, "--force", help="Force deployment even if services are running"
    ),
):
...
def production(
    ...
    backup: bool = typer.Option(
        True, "--backup/--no-backup", help="Create database backup before deployment"
    ),
):
...
def status(
    environment: Optional[str] = typer.Option(
        None, "--env", "-e", help="Environment to check (staging, production)"
    )
):
...
def stop(
    environment: Optional[str] = typer.Option(
        None, "--env", "-e", help="Environment to stop (staging, production)"
    ),
...
def logs(
    ...
    tail: Optional[int] = typer.Option(
        None, "--tail", "-n", help="Number of lines to show from end of logs"
    ),
    environment: Optional[str] = typer.Option(
        None, "--env", "-e", help="Environment (staging, production)"
    ),
):
