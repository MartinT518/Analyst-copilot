...
@app.command()
def run(
    service: Optional[str] = typer.Option(None, "--service", "-s", help="Run tests for specific service (ingest, agents, cli)"),
    with_coverage: bool = typer.Option(False, "--coverage", "-c", help="Run tests with coverage reporting"),
    verbose: bool = typer.Option(False, "--verbose", "-v", help="Verbose output"),
    fail_fast: bool = typer.Option(False, "--fail-fast", "-x", help="Stop on first failure"),
    pattern: Optional[str] = typer.Option(None, "--pattern", "-k", help="Run tests matching pattern"),
...
@app.command()
def lint(
    service: Optional[str] = typer.Option(None, "--service", "-s", help="Lint specific service (ingest, agents, cli)"),
...
def performance(
    ...
    target_url: Optional[str] = typer.Option(None, "--url", help="Target URL for performance testing")
):
