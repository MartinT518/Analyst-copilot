...
class ConfigManager:
    ...
    def _get_env_overrides(self) -> Dict[str, Any]:
        ...
        if os.getenv("ACP_CODE_ANALYZER_URL"):
            overrides.setdefault("code_analyzer_service", {})["url"] = os.getenv(
                "ACP_CODE_ANALYZER_URL"
            )
        ...
        if os.getenv("ACP_CODE_ANALYZER_API_KEY"):
            overrides.setdefault("code_analyzer_service", {})["api_key"] = os.getenv(
                "ACP_CODE_ANALYZER_API_KEY"
            )
